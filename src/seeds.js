...
// Fighter Seeds
// ---------------------
export const MishaCirkunov = new Fighter ({name: "Misha Cirkunov", subWins: "1 Win via Peruvian Necktie,", img: "../src/assets/Fighters/Misha_cirkunov_peruvian.png"});
export const CouldBeYou = new Fighter({name: "Nobody has finished a UFC fight with this submission yet...  You could be the first! Check out this awesome tutorial video and make it a reality!", subWins: "", img: "../src/assets/Fighters/Mystery_Fighter.png"});
export const DemianMaiaRNC = new Fighter({name: "Demian Maia", subWins: "8 Wins via Rear-Naked Choke", img: "../src/assets/Fighters/Demian_Maia_RNC.png"}); 
export const MakwanAmirkhani = new Fighter({name: "Makwan Amirkhani", subWins: "3 Wins via Anaconda Choke", img: "../src/assets/Fighters/Makwan_Amirkhani.png"});
export const VincenteLuque = new Fighter({name: "Vincete Luque", subWins: "4 Wins via D'arce Choke", img: "../src/assets/Fighters/Vincente_Luque_anaconda.png" });
export const NateDiazGuillotine = new Fighter({name: "Nate Diaz", subWins: "5 Wins via Guillotine", img: "../src/assets/Fighters/Nate_Diaz_Guillotine.png"});
export const AlexeyOleynik = new Fighter ({name: "Alexey Oleynik", subWins: "2 Wins via Ezekiel", img: "../src/assets/Fighters/Alexey_Oleynik_Ezekiel.png" });
export const NickDiaz = new Fighter ({name: "Nick Diaz", subWins: "1 Win via Gogoplata (Pride FC)", img: "../src/assets/Fighters/Nick_Diaz_Gogoplata.png"});
export const UriahFaber = new Fighter({name: "Uriah Faber", subWins: "1 Win via Bulldog Choke", img: "../src/assets/Fighters/Uriah_Faber_Bulldog.png"});
export const IslamMakhachev = new Fighter({name: "Islam Makhachev", subWins: "2 Wins via Arm-Triangle", img: "../src/assets/Fighters/Islam_Makhachev_ArmTriangle.png" });
export const NateDiazTriangle = new Fighter({name: "Nate Diaz", subWins: "4 Wins via Triangle Choke", img: "../src/assets/Fighters/Nate_Diaz_Triangle.png"});
export const JeffMonson = new Fighter({name: "Jeff Monson", subWins: "17 Wins via North-South Choke (various promotions, 2 in UFC)", img: "../src/assets/Fighters/Jeff_Monson_NSCHOKE.png"});
export const PhoenixJones = new Fighter({name: "Phoenix Jones", subWins: "1 Win via Leg Scissor (World Series of Fighting)", img: "../src/assets/Fighters/Phoenix_Jones_legScissor.png"});
export const MarkColeman = new Fighter({name: "Mark Coleman", subWins: "3 Wins via Neck-Crank", img: "../src/assets/Fighters/Mark_Colman_NeckCrank.png"});
export const FrankMirKimura = new Fighter({name: "Frank Mir", subWins: "2 Wins via Kimura", img: "../src/assets/Fighters/Frank_Mir_Kimura.png"});
export const JonJones = new Fighter({name: "Jon Jones", subWins: "1 Win via Americana", img: "../src/assets/Fighters/Jon_Jones_Americana.png"});
export const BenSaunders = new Fighter({name: "Ben Saunders", subWins: "1 Win via Omoplata", img: "../src/assets/Fighters/Ben_Saunders_Omoplata.png"});
export const DemetriousJohnson = new Fighter({name: "Demetrious Johnson", subWins: "4 Wins via Armbar", img: "../src/assets/Fighters/DJ_Armbar.png"});
export const KoreanZombie = new Fighter({name: "Korean Zombie", subWins: "1 Win via Twister", img: "../src/assets/Fighters/Korean_Zombie_Twister.png"} );
export const RyanHall = new Fighter({name: "Ryan Hall", subWins: "1 Win via Inside Heel-Hook", img: "../src/assets/Fighters/Ryan_Hall_heel-hook.png"});
export const RousimarPalhares = new Fighter({name: "Rousimar Palhares", subWins: "5 Wins via Outside Heel-Hook", img: "../src/assets/Fighters/Rousimar_Palheres_Heel-hook.png"});
export const ClaudioPuelles = new Fighter({name: "Claudio Puelles", subWins: "3 Wins via Kneebar", img: "../src/assets/Fighters/Claudio_Puelles_Kneebar.png"});
export const CharlesOliveira = new Fighter({name: "Charles Oliveira", subWins: "1 Win via Calf-Slicer", img: "../src/assets/Fighters/Charles_Oliveira_CalfSlicer.png"});
export const BrendonAllen = new Fighter({name: "Brendon Allen", subWins: "1 Win via Straight-Ankle Lock", img: "../src/assets/Fighters/Brendan_Allen_AnkleLock.png"});
export const FrankMirToeHold = new Fighter({name: "Frank Mir", subWins: "1 Win via Toe-Hold", img: "../src/assets/Fighters/Frank_Mir_ToeHold.png"});
// Submission Seeds
// ------------------
